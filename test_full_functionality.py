...
class TestFullFunctionalityVRChatMemories(unittest.TestCase):
    ...
    def test_event_creation(self):
        ...
        with app.app_context():
            ...
            self.assertIn(
                'New Friend', [
                    event.friend_name for event in events])
    ...
    def test_world_creation(self):
        ...
        # 验证世界已创建
        with app.app_context():
            new_world = World.query.filter_by(
                world_name='Auto Created World').first()
    ...
    def test_full_user_flow(self):
        ...
        # 获取创建的事件ID
        with app.app_context():
            flow_event = SharedEvent.query.filter_by(
                friend_name='Flow Friend').first()
